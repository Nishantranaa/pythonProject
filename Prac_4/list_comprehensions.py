...
#                  full_names]
# print(full_initials)
# # The code above splits the list of two strings into separate indexes 0 and 1 index 0 is the first word for every word
# # in the list, and 1 is the second word in every list.
# # The second [] is the index for a single character.
#
